...
class ViewRDAAdapter(private val mList: List<RDA>) : RecyclerView.Adapter<ViewRDAAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.view_rda_layout, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.provinceView.text = itemsViewModel.province
        holder.directorValue.text = itemsViewModel.director
    }
    ...
    class ViewHolder(ItemView: View) : RecyclerView.ViewHolder(ItemView) {
        ...
        val provinceView: TextView = itemView.findViewById(R.id.lblProvinceValue)
        val directorValue: TextView = itemView.findViewById(R.id.lblPDValue)
    }
}
